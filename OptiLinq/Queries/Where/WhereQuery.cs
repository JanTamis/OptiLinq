	...
	where TBaseEnumerator : struct, IOptiEnumerator<T>
{
	...
	{
		return new QueryAsEnumerable<T, WhereQuery<T, TOperator, TBaseQuery, TBaseEnumerator>, WhereEnumerator<T, TOperator, TBaseEnumerator>>(this);
	}
