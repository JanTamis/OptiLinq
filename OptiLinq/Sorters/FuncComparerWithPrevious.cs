...
public readonly struct FuncComparerWithPrevious<T, TKey, TPrevious> : IOptiComparer<T>
	where TPrevious : IOptiComparer<T>
{
	private readonly Func<T, TKey> _keySelector;
	private readonly TPrevious _previous;

	public FuncComparerWithPrevious(Func<T, TKey> keySelector, TPrevious previous)
	{
...
public readonly struct FuncComparerWithPrevious<T, TKey, TKeyComparer, TPrevious> : IOptiComparer<T>
	...
	where TPrevious : IOptiComparer<T>
{
	...
	public FuncComparerWithPrevious(Func<T, TKey> keySelector, TKeyComparer keyComparer, TPrevious previous)
	{
		_keySelector = keySelector;
