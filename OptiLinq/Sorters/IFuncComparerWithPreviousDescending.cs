...
public readonly struct IFuncComparerWithPreviousDescending<T, TKey, TKeySelector, TPrevious> : IOptiComparer<T>
	...
	where TPrevious : IOptiComparer<T>
{
	...
	public IFuncComparerWithPreviousDescending(TKeySelector keySelector, TPrevious previous)
	{
...
public readonly struct IFuncComparerWithPreviousDescending<T, TKey, TKeySelector, TKeyComparer, TPrevious> : IOptiComparer<T>
	where TKeySelector : IFunction<T, TKey>
	...
	where TPrevious : IOptiComparer<T>
{
	...
	public IFuncComparerWithPreviousDescending(TKeySelector keySelector, TKeyComparer keyComparer, TPrevious previous)
	{
		_keySelector = keySelector;
